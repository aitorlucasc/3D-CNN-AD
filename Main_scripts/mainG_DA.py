...
from cnn3d_DA import CNN3D
from adSequenceDA import adSequenceDA

out_dir = "/homedtic/alucas/labels2_DA/"
...
# 1. Load image paths
my_filtered_csv = pd.read_csv("/homedtic/alucas/DataCSV/CN_AD.csv")
...
adSeq = adSequenceDA(X_train, y_train, batch_size=4)
adSeq_test = adSequenceDA(X_test, y_test, batch_size=4)
adSeq_val = adSequenceDA(X_val, y_val, batch_size=4)
